...
import (
	...
	dbInfra "github.com/flaviomdutra/product-srv-hexagonal/adapters/db"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.product-srv-hexagonal.yaml)")
